...
VINAYAK REVISANKER contributed to this exercise
...
```{r}
#| label: bmi-dist
#| fig-cap: "Body Mass Index (BMI) distribution."
#| echo: FALSE
knitr::include_graphics(here("starter-analysis-exercise","results","figures","bmi-distribution.png"))
```

@mean-height-race shows a bar graph of the average height by race.

```{r}
#| label: mean-height-race
#| fig-cap: "Average Height by Race."
#| echo: FALSE
knitr::include_graphics(here("starter-analysis-exercise","results","figures","mean-height-by-race.png"))
```
...
```{r}
#| label: weight-bmi
#| fig-cap: "Distribution of Weight and BMI."
#| echo: FALSE
knitr::include_graphics(here("starter-analysis-exercise","results","figures","weight-bmi.png"))
```
...
```
@tbl-resulttable3 shows a linear model with Height as the outcome and ShoeSize and EyeColor as the predictors.

```{r}
#| label: tbl-resulttable3
#| tbl-cap: "Linear model fit table."
#| echo: FALSE
resulttable3 = readRDS(here("starter-analysis-exercise","results","tables-files","resulttable2.rds"))
